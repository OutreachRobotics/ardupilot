...
void Copter::fifty_hz_logging()
{
    ...
    gcs().set_rangefinder_distance(float(rangefinder.distance_cm_orient(ROTATION_PITCH_270))*cos(RANGEFINDER_ANGLE+attitude_control->getDelEKFOrientation().y)/100.0f);
}
